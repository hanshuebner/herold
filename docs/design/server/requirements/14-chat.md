...
- **REQ-CHAT-01** MUST advertise `https://netzhansa.com/jmap/chat` as a JMAP capability when chat is enabled. Per-account capability when the account has chat access.
