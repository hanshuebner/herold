...
- Client opens the WebSocket after the JMAP session descriptor confirms `https://netzhansa.com/jmap/chat`. The suite session cookie attaches automatically; no separate auth handshake.
