...
export const de = {
  ...
  'sidebar.snoozed': 'Zurueckgestellt',
  'sidebar.important': 'Wichtig',
  'sidebar.sent': 'Gesendet',
  'sidebar.drafts': 'Entwuerfe',
  ...
  'thread.empty': 'Diese Konversation enthaelt keine Nachrichten.',
  ...
  'msg.filterLike': 'Filter fuer aehnliche Nachrichten',
  ...
  'compose.close': 'Verfassen schliessen',
  'compose.from': 'Von',
  'compose.to': 'An',
  'compose.cc': 'Cc',
  'compose.bcc': 'Bcc',
  ...
  'compose.attach': 'Anhaengen',
  'compose.attached': 'Anhaenge',
  'compose.dropToAttach': 'Hier ablegen zum Anhaengen',
  ...
  'movePicker.empty': 'Keine anderen Ordner verfuegbar.',
  'movePicker.empty.filter': 'Keine Ordner passen zu "{filter}".',
  'labelPicker.title.single': 'Etiketten zuweisen',
  'labelPicker.title.bulk': '{count} Nachricht etikettieren',
  'labelPicker.title.bulk.other': '{count} Nachrichten etikettieren',
  'labelPicker.filter': 'Etiketten filtern...',
  'labelPicker.empty':
    'Noch keine Etiketten. Erstelle einen eigenen Ordner in der Seitenleiste, um ihn als Etikett zu verwenden.',
  'labelPicker.empty.filter': 'Keine Etiketten passen zu "{filter}".',
