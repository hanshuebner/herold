...
export const en = {
  ...
  'settings.sessions.revokeAll': 'Sign out all other sessions',
  'settings.sessions.revokeConfirm': 'Sign out this session? It will be signed out immediately.',
  ...
  'settings.sessions.allRevoked': 'All other sessions signed out.',
  'settings.sessions.error': 'Could not load sessions.',
  'settings.sessions.revokeError': 'Could not sign out the session.',
