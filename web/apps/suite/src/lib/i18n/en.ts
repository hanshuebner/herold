...
export const en = {
  ...
  'sidebar.newMailbox': 'New folder',
  'sidebar.noCustom': 'No custom folders.',
  'sidebar.rename': 'Rename',
  'sidebar.delete': 'Delete',
  'sidebar.chats': 'Chats',
  'sidebar.newChat': 'New chat',
  'sidebar.createFolder.title': 'New folder',
  'sidebar.createFolder.label': 'Folder name',
  'sidebar.createFolder.confirm': 'Create',
  'sidebar.renameFolder.title': 'Rename folder',
  'sidebar.renameFolder.label': 'New name',
  'sidebar.renameFolder.confirm': 'Rename',
  'sidebar.deleteFolder.title': 'Delete folder "{name}"?',
  'sidebar.deleteFolder.message':
    "Messages it contains will remain in any other folders they're in (otherwise they go to Trash on the server).",
  ...
  'picker.close': 'Close',
  'movePicker.title.single': 'Move to folder',
  'movePicker.title.bulk': 'Move {count} message to',
  'movePicker.title.bulk.other': 'Move {count} messages to',
  'movePicker.filter': 'Filter folders...',
  'movePicker.empty': 'No other folders available.',
  'movePicker.empty.filter': 'No folders match "{filter}".',
