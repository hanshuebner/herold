...
-- general write path. SQLite supports partial indexes via WHERE.
-- Forward-only; the migrations table records 0007 as applied.

ALTER TABLE messages ADD COLUMN snoozed_until_us INTEGER;
