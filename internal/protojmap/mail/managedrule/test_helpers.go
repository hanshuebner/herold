...
// testPrincipalKey is the package-private ctx key for in-package tests.
type testPrincipalKey struct{}

// contextWithTestPrincipal stores p under a package-private key so
// principalFromTestCtx can recover it. Used by managedrule_test.go fixtures.
...
// principalFromTestCtx returns the test-installed principal when present,
// falling back to protojmap's standard lookup.
