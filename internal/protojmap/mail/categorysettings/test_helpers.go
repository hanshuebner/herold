...
func (r *recategoriseHandler) executeAs(p store.Principal, args json.RawMessage) (any, *protojmap.MethodError) {
	return r.Execute(contextWithTestPrincipal(context.Background(), p), args)
}
