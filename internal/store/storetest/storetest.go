...
func Run(t *testing.T, f Factory) {
	...
	cases := []struct {
		...
		// REQ-IMAP-IMP-106/107).
		{"SubAccountMigration_SeparateIdentityIsIdempotent", testSubAccountMigration_SeparateIdentityIsIdempotent},
		{"SubAccountMigration_RunMovesSoleClaimedMail", testSubAccountMigration_RunMovesSoleClaimedMail},
		{"SubAccountMigration_RunCopiesDedupSafe", testSubAccountMigration_RunCopiesDedupSafe},
		...
		{"TaggedAddressFilter_CaseInsensitiveSuffix", testTaggedAddressFilterCaseInsensitiveSuffix},
		{"TaggedAddressFilter_Update", testTaggedAddressFilterUpdate},
		{"TaggedAddressFilter_List_Order", testTaggedAddressFilterListOrder},
		{"TaggedAddressFilter_Duplicate_Conflict", testTaggedAddressFilterDuplicateConflict},
		{"TaggedAddressFilter_Invalid_Action", testTaggedAddressFilterInvalidAction},
		{"TaggedAddressFilter_Cap_Enforced", testTaggedAddressFilterCap},
		{"TaggedAddressDismissal_RoundTrip", testTaggedAddressDismissalRoundTrip},
		{"TaggedAddressDismissal_Idempotent", testTaggedAddressDismissalIdempotent},
		{"TaggedAddressDismissal_Delete", testTaggedAddressDismissalDelete},
		{"TaggedAddressDismissal_Cap_Enforced", testTaggedAddressDismissalCap},
		{"TaggedAddress_DeleteFilter_CascadesDismissal", testTaggedAddressDeleteFilterCascadesDismissal},
		{"TaggedAddress_DeleteFilter_NoDismissal_OK", testTaggedAddressDeleteFilterNoDismissalIsOK},
		...
		// -- REQ-SHARE-01..23 attachment shares ----------------------
		{"FileShare_CreateAndGet_Roundtrip", testFileShareCreateAndGetRoundTrip},
		{"FileShare_Token_Entropy", testFileShareTokenEntropy},
		{"FileShare_Confirm_Idempotent", testFileShareConfirmIdempotent},
		{"FileShare_Confirm_ClampedToMaxTTL", testFileShareConfirmClampedToMaxTTL},
		{"FileShare_Confirm_RevokedFails", testFileShareConfirmRevokedFails},
		{"FileShare_Revoke_AndGetReturnsRevoked", testFileShareRevokeAndGetReturnsRevoked},
		{"FileShare_Revoke_WrongPrincipalFails", testFileShareRevokeWrongPrincipalFails},
		{"FileShare_Destroy_DeletesRow", testFileShareDestroyDeletesRow},
		{"FileShare_GetByID_ReturnsAllStates", testFileShareGetByIDReturnsAllStates},
		{"FileShare_CountCap_Enforced", testFileShareCountCap},
		{"FileShare_Quota_Enforced", testFileShareQuotaEnforced},
		{"FileShare_Quota_DedupZeroCost", testFileShareQuotaDedupZeroCost},
		{"FileShare_RecordDownload", testFileShareRecordDownload},
		{"FileShare_List_ByPrincipal", testFileShareListByPrincipal},
		{"FileShare_Sweep_Pending", testFileShareSweepPending},
		...
		// -- API key elevation (api_key_elevations table, REQ-AUTH-74, REQ-AUTH-78, issue #357) --
		{"APIKeyElevation_UpsertGet_Roundtrip", testAPIKeyElevationUpsertGetRoundtrip},
		{"APIKeyElevation_Get_Expired_ReturnsNotFound", testAPIKeyElevationGetExpiredReturnsNotFound},
		{"APIKeyElevation_Get_ExpiredByAbsoluteCap_ReturnsNotFound", testAPIKeyElevationGetExpiredByAbsoluteCapReturnsNotFound},
		{"APIKeyElevation_Get_NotFound", testAPIKeyElevationGetNotFound},
		{"APIKeyElevation_Upsert_RefreshesWindow", testAPIKeyElevationUpsertRefreshesWindow},
		{"APIKeyElevation_Delete_RemovesRow", testAPIKeyElevationDeleteRemovesRow},
		{"APIKeyElevation_Delete_NotFound", testAPIKeyElevationDeleteNotFound},
		{"APIKeyElevation_Cascade_OnKeyDelete", testAPIKeyElevationCascadeOnKeyDelete},
		{"APIKeyElevation_EvictExpired_RemovesExpiredLeavesAlive", testAPIKeyElevationEvictExpired},
		{"APIKeyElevation_Extend_SlidesIdleDeadline", testAPIKeyElevationExtendSlidesIdleDeadline},
		{"APIKeyElevation_Extend_ClampedToAbsoluteDeadline", testAPIKeyElevationExtendClampedToAbsoluteDeadline},
		{"APIKeyElevation_Extend_NotFoundWhenIdleExpired", testAPIKeyElevationExtendNotFoundWhenIdleExpired},
		...
		{"IMAPImport_ListEnabled", testIMAPImport_ListEnabled},
		...
		{"IMAPImport_OwnAddresses", testIMAPImport_OwnAddresses},
		{"IMAPImport_LearnedAddresses", testIMAPImport_LearnedAddresses},
		...
		{"Grants_InsertListDelete", testGrants_InsertListDelete},
		{"Grants_InsertIdempotent", testGrants_InsertIdempotent},
