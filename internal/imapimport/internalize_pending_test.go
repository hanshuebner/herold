...
//
// Every test runs against both store backends via ownSentDedupBackends
// (sync_test.go, built for the analogous #376 store fix): sqlite
// always, plus postgres when HEROLD_PG_DSN is set.
