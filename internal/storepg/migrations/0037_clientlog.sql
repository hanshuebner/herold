...
CREATE TABLE clientlog (
  ...
  slice         TEXT        NOT NULL,
  server_ts     BIGINT      NOT NULL,  -- Unix microseconds (server arrival)
  client_ts     BIGINT      NOT NULL,  -- Unix microseconds (browser wall clock)
  clock_skew_ms BIGINT      NOT NULL,  -- signed: server_ts_ms - client_ts_ms
  app           TEXT        NOT NULL,
  kind          TEXT        NOT NULL,
  level         TEXT        NOT NULL,
  user_id       TEXT,
